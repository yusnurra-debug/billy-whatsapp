...
@app.post("/webhook")
async def whatsapp_webhook(request: Request, Body: str = Form(default=""), From: str = Form(default=""), NumMedia: str = Form(default="0")):
    body = Body.strip()
    if int(NumMedia) > 0:
...
_Saved to your Google Sheet!_"
        ...
        reply = f"❌ Google Sheets error — share the sheet with your service account.
_{str(e)[:80]}_"
